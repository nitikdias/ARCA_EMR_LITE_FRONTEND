    ...
    return [
      {
        ...
        destination: 'https://infer.e2enetworks.net/project/p-8621/endpoint/is-7613/:path*',
      },
      {
        source: '/api/whisper/:path*',
        destination: 'https://infer.e2enetworks.net/project/p-8621/endpoint/is-7609/:path*',
      },
    ];
  },
};
