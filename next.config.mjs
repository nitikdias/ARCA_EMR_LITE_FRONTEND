    ...
    return [
      {
        ...
        destination: 'https://infer.e2enetworks.net/project/p-8621/endpoint/is-7602/:path*',
      },
      {
        source: '/api/whisper/:path*',
        destination: 'https://infer.e2enetworks.net/project/p-8621/endpoint/is-7598/:path*',
      },
    ];
  },
};
